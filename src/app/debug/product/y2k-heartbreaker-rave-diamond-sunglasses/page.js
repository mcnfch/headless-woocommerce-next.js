...
export const metadata = {
  title: 'Y2K Heartbreaker Rave Diamond Sunglasses - Debug Product Page',
  description: 'Perfect festival and rave sunglasses with Y2K style and diamond accents'
};
  ...
  try {
    ...
    for (const key of keys) {
      ...
      if (productData) {
        ...
        if (product.slug === 'y2k-heartbreaker-rave-diamond-sunglasses') {
...
export default async function ProductPage() {
  const { product, relatedProducts } = await getProduct();
