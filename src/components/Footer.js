...
const Footer = () => {
  ...
  useEffect(() => {
    const getMenuItems = async () => {
      try {
        setLoading(true);
        const items = await fetchMenu(437); // footer menu ID
        console.log('Footer menu items:', items); // Debug log
    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2">
            ...
            {loading ? (
              ...
              <div className="text-gray-300">Error loading menu: {error}</div>
            ) : (
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p>Email: info@groovygallerydesigns.com</p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p> {new Date().getFullYear()} Groovy Gallery Designs. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
