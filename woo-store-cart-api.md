...
All POST endpoints require Nonce Tokens and return the updated state of the full cart once complete.
...
Returns the full cart object response (see Cart Response).
...
Returns the full Cart Response on success, or an Error Response on failure.

If you want to add supplemental cart item data before it is passed into CartController::add_to_cart use the woocommerce_store_api_add_to_cart_data filter. For example:
